namespace ProbeSampler.Core.Services.Contract
{
    ...
    public interface IStorageService
    {
        ...
        /// <returns></returns>
        IEnumerable<T> Load<T>(string pathToFolder) where T : ISavableEntity;
        /// <summary>
        /// Загрузить все объекты по пути
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="pathToFolder"></param>
        /// <returns></returns>
        Task<IEnumerable<T>> LoadAsync<T>(string pathToFolder) where T : ISavableEntity;
        /// <summary>
        ...
        /// <param name="pathToFolder"></param>
        /// <returns></returns>
        T? Load<T>(string nameToLoad, string pathToFolder) where T : ISavableEntity;
        /// <summary>
        /// Загрузить объект по имени
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <param name="pathToFolder"></param>
        /// <returns></returns>
        Task<T?> LoadAsync<T>(string nameToLoad, string pathToFolder) where T : ISavableEntity;
        /// <summary>
        /// Сохранить объект
        /// </summary>
