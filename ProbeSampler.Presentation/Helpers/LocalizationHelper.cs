    ...
    public static class LocalizationHelper
    {
            ...
            where T : Enum
        {
            return value switch
            {
                ...
                GridEditMode gridEditMode => HandleDeleteModeType(gridEditMode),
        ...
        private static string HandleDeleteModeType(GridEditMode deleteModeType)
        {
            string result = "Неопределённо";

            switch (deleteModeType)
            {
                case GridEditMode.Cells:
                    result = "Удалить клетки";
                    break;
                case GridEditMode.Crossbars:
