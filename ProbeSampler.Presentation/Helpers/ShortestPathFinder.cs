...
{
    /// <summary>
    /// Класс, отвечающий за поиск кратчайшего пути с использованием библиотеки OR-Tools и алгоритма Дейкстры.
    /// </summary>
    public class ShortestPathFinder
    {
        ...
        private List<Cell> GetSolution(RoutingModel routing, RoutingIndexManager manager, Assignment solution)
        {
            ...
            // разобраться в каком порядке возвращается убрать этот костыль
        ...
        /// <summary>
        /// Поиск кратчайшего пути с использованием алгоритма Деийкстры. 
        ...
        /// Работает в среднем хуже чем обычная сортировка клеток по смещению
        /// </summary>
        ...
        /// <summary>
        /// Костыль к OR tools, не хотел стабильно ставить конечной точкой точку с максимальным смещением 
        /// </summary>
        /// <param name="resultCells"></param>
        /// <returns></returns>
