...
namespace ProbeSampler.Presentation
{
    ...
    public class CalibrationViewModel : RoutableViewModelBase, IEnableLogger
    {
        ...
        [Reactive] public int PatternWidth { get; private set; }
        [Reactive] public int PatternHeight { get; private set; }
        [Reactive] public float SquareSize { get; private set; }
        [Reactive] public bool IsCurentlyLoading { get; private set; }
