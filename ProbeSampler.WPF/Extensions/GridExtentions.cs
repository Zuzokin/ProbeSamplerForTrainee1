...
namespace ProbeSampler.WPF.Extensions
{
    public static class GridExtentions
    {
        ...
        DependencyProperty.RegisterAttached(
            "RowCount", typeof(int), typeof(GridExtentions),
        ...
        public static readonly DependencyProperty ColumnCountProperty =
            DependencyProperty.RegisterAttached(
                "ColumnCount", typeof(int), typeof(GridExtentions),
        ...
        public static readonly DependencyProperty StarRowsProperty =
            DependencyProperty.RegisterAttached(
                "StarRows", typeof(string), typeof(GridExtentions),
        ...
        public static readonly DependencyProperty StarColumnsProperty =
            DependencyProperty.RegisterAttached(
                "StarColumns", typeof(string), typeof(GridExtentions),
        ...
        public static T? Parent<T>(this DependencyObject root)
            where T : class
        {
            if (root is T)
            {
        ...
        private static int GetData<T>(IEnumerable<T> list, double value)
            where T : DefinitionBase
        {
            var start = 0.0;
            var result = 0;

            var property = Array.Find(typeof(T).GetProperties(), p => p.Name.StartsWith("Actual"));
            if (property == null)
            {
                return result;
            }
            ...
            {
                if (property.GetValue(definition) is double val)
                {
                    start += val;
                }
