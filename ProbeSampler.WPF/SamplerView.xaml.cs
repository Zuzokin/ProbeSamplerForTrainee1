    ...
    public partial class SamplerView
    {
        ...
        private void SetupBinding()
        {
            this.WhenActivated(d =>
            {
                ...
                this.Bind(ViewModel, vm => vm.DeleteCellsSwitch, v => v.tglBtnModeChanger.IsChecked).DisposeWith(d);
                ...
                this.OneWayBind(ViewModel, vm => vm.DeletedCellsMode, v => v.SelectionModeCaption.Text, LocalizationHelper.ToDisplayText).DisposeWith(d);
        ...
        private void Rect_LeftMouseDown(object sender, MouseButtonEventArgs e)
        {
                ...
                )
            {
                ...
                // Если включен режим удаления клеток
                if (ViewModel.DeleteCellsSwitch)
                {
                    if (ViewModel.Cells.Where(cell => cell.CellState == CellState.Selected).Count() > ViewModel.CellsNumberToSelect)
                        CellsHelper.ResetCell(cell);
                }
